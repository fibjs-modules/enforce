...
describe("enforce.patterns", function () {
	it("should have .match()", function (done) {
		assert.isFunction(enforce.patterns.match);

		return done();
	});
	it("should have .hexString()", function (done) {
		assert.isFunction(enforce.patterns.hexString);

		return done();
	});
	it("should have .email()", function (done) {
		assert.isFunction(enforce.patterns.email);

		return done();
	});
	it("should have .ipv4()", function (done) {
		assert.isFunction(enforce.patterns.ipv4);

		return done();
	});
	it("should have .ipv6()", function (done) {
		assert.isFunction(enforce.patterns.ipv6);

		return done();
	});
	it("should have .mac()", function (done) {
		assert.isFunction(enforce.patterns.mac);

		return done();
	});
	it("should have .uuid3()", function (done) {
		assert.isFunction(enforce.patterns.uuid3);

		return done();
	});
	it("should have .uuid4()", function (done) {
		assert.isFunction(enforce.patterns.uuid4);
...
describe("enforce.patterns.email()", function () {
	...
	it("should not pass 'long.tld.upto.63.char@example.abcdefghabcdefghabcdefghabcdefghabcdefghabcdefghabcdefghabcdefg'", function (done) {
		validator.validate('long.tld.upto.63.char@example.abcdefghabcdefghabcdefghabcdefghabcdefghabcdefghabcdefghabcdefg', common.checkValidation(done, 'not-valid-email'));
	});
